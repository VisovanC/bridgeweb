...
var StandardWalletAdapter = class {
  constructor({ wallet }) {
    ...
    this.signPersonalMessage = (messageInput) => {
      if (!__privateGet(this, _wallet).features["sui:signPersonalMessage"]) {
        throw new Error("Wallet does not support the new `signPersonalMessage` method.");
      }
      return __privateGet(this, _wallet).features["sui:signPersonalMessage"].signPersonalMessage(messageInput);
    };
  ...
  async connect() {
    try {
      ...
      __privateSet(this, _walletEventUnsubscribe, __privateGet(this, _wallet).features["standard:events"].on(
        "change",
        async ({ accounts }) => {
          if (accounts) {
...
var WalletStandardAdapterProvider = class {
  constructor({ features } = {}) {
    ...
    __privateSet(this, _wallets, getWallets());
    __privateSet(this, _events2, mitt2());
  ...
  get() {
    const filtered = __privateGet(this, _wallets).get().filter(
      (wallet) => isStandardWalletAdapterCompatibleWallet(wallet, __privateGet(this, _features))
    );
